...
<head runat="server">
    <title>Student Grades - Fall 2011</title>
</head>
<body>
    ...
    <div>
        ...
        <p style="text-align: center">
            <strong><span style="font-family: Arial">Please input your ID here (8 digits&nbsp; 
            e.g : 12345678) and press
        ...
        <p>
            <strong><span style="font-family: Arial">
                <asp:AccessDataSource ID="DataSource" runat="server" DataFile="Fall2011.mdb"
                    SelectCommand="SELECT * FROM [Fall2011] WHERE ([ID] = ?)">
                    <SelectParameters>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DataSourceID="DataSource" OnPageIndexChanging="FormView1_PageIndexChanging" Height="488px" Width="724px">
            ...
            <ItemTemplate>
                ...
                <br />
                <span style="font-size: 16pt">(Exam 1 &amp; 2 grades will be converted to 15 max at
                    the end of semester)</span><br />
                <span style="font-size: 16pt"> Exam 1 - max 15 : &nbsp;
                ...
                <span style="font-size: 16pt"> Exam 2 - max 15 : &nbsp;&nbsp; </span>
                ...
                <br />
                <span style="font-size: 16pt"> Homework 1 - max 10&nbsp; &nbsp;
                    &nbsp;&nbsp; : &nbsp; &nbsp; </span>
                ...
                <span style="font-size: 16pt"> Homework 2 - max 10 &nbsp; &nbsp;
                    &nbsp; : &nbsp; &nbsp; </span>
                ...
                <br />
                <span style="font-size: 16pt"> Project Progress - max 5&nbsp;&nbsp; : &nbsp;&nbsp; </span>
                ...
                <span style="font-size: 16pt"> Project Present &nbsp; - max 15&nbsp; : &nbsp; &nbsp;</span><asp:Label ID="ProjectPresentLabel" runat="server" Font-Bold="True"
                        Font-Names="Arial" Font-Size="14pt" ForeColor="Red" Text='<%# Bind("ProjectPresent") %>'></asp:Label>
                <br />
                <span style="font-size: 16pt">
                Class Topics&nbsp; &nbsp; - max 
                30&nbsp; : &nbsp;&nbsp;&nbsp; &nbsp;</span><asp:Label ID="ClassTopicLabel" runat="server" 
                    Font-Bold="True" Font-Names="Arial" Font-Size="14pt" ForeColor="Red" 
                    Text='<%# Bind("ClassTopic") %>'></asp:Label>
                <br />
                <br />
                <span style="font-size: 16pt">Extra Points &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : </span>
                &nbsp;&nbsp;
                ...
                <span style="font-size: 16pt">(10% for all project presentation attendance)</span><br />
                <br />
                <br />
                <span style="font-size: 16pt">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
