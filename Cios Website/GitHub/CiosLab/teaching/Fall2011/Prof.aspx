...
<head runat="server">
    <title>Professor's Management Page - Fall 2011</title>
</head>
<body>
    ...
    <div style="text-align: center">
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="Fall2011.mdb"
            SelectCommand="SELECT * FROM [Fall2011] WHERE (txtAcc = 'abc12') order by dummy">
            <SelectParameters>
        ...
        <p style="text-align: center">
            <asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="Fall2011.mdb"
                SelectCommand="SELECT COUNT(ID)-2 AS Expr1 FROM Fall2011 rs"></asp:AccessDataSource>
            &nbsp;</p>
        <p style="text-align: center">
            ...
            &nbsp;</p>
        <p style="text-align: center">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="AccessDataSource1" Width="1125px" style="border-top-style: solid; border-right-style: solid; border-left-style: solid; border-bottom-style: solid">
            <Columns>
                ...
                <asp:BoundField DataField="ProjectProgress" HeaderText="Project Progress (max=5)"
                    ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="30px" VerticalAlign="Middle" />
                </asp:BoundField>
                <asp:BoundField DataField="Homework1" HeaderText="HW1(max=10)">
                    <ItemStyle Width="30px" HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:BoundField>
                <asp:BoundField DataField="MidTerm1" HeaderText="Exam 1(max=15)" 
                    ReadOnly="True">
                    <ItemStyle HorizontalAlign="Center" Width="30px" VerticalAlign="Middle" />
                </asp:BoundField>
                <asp:BoundField DataField="Homework2" HeaderText="HW2(max=10)">
                    <ItemStyle Width="30px" HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:BoundField>
                <asp:BoundField DataField="Midterm2" HeaderText="Exam2(max=15)">
                    <ItemStyle Width="30px" HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:BoundField>
                <asp:BoundField DataField="ProjectPresent" HeaderText="Final Report(max=15)">
                    <ItemStyle Width="30px" HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:BoundField>
                <asp:BoundField DataField="ClassTopic" HeaderText="Class Topic(max=30)" 
                    ReadOnly="True">
                <ItemStyle Width="30px" />
                </asp:BoundField>
                <asp:BoundField DataField="Bonus" HeaderText="Extra Pts*">
        ...
        <p style="text-align: left">
            * Extra Points = 10% if all project presentation attendance</p>
        <p style="text-align: left">
            Exam 1 and 2 grades will be convert to 15 max at the end of semester</p>
        <p>
            <asp:TextBox ID="Bonus" runat="server" Height="16px" ReadOnly="True" TextMode="MultiLine"
                Visible="False" Width="16px"></asp:TextBox>&nbsp;</p>
        <p>
   ...
   <asp:Button ID="UncheckAll" runat="server" Text="Uncheck All" Visible="False" />
        ...
        <p>
            <asp:TextBox ID="TextBox1" runat="server" Height="99px" TextMode="MultiLine" Visible="False"
                Width="593px"></asp:TextBox>&nbsp;</p>
        <p>
            <asp:TextBox ID="TextBox2" runat="server" Font-Bold="True" Font-Size="12pt" Height="90px"
                ReadOnly="True" TextMode="MultiLine" Visible="False" Width="639px">Select text in above textbox, using Edit/Copy ( or press Ctr-C) then return webmail, paste in To item</asp:TextBox>&nbsp;</p>
        <p>
            &nbsp;</p>
        <p>
            &nbsp;</p>
